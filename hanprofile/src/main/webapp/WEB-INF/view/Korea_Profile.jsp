...
<html lang="ko">
  ...
  <body>
  		...
  		<div class="container">
  			<div class="row">
  				<div class="col-md-12 col-sm-12 top_box">
  					<h2>안녕하세요!</h2>
  				</div>		
  				
  				<div class="col-md-2 col-sm-12 My_menu_bar">
  				...
  				<div class="col-md-10 col-sm-12" >
  					...
  					<div class="row">
	  					...
	  					<div class="col-md-3 col-sm-3 borders">
	  						<span>나이 : 만 27 세</span>
	  					</div>
	  					<div class="col-md-3 col-sm-3 borders">
	  						<span>사진</span>
  					...
  					<div class="row">
  						<div class="col-md-9 col-sm-9 borders">
  					...
  					<div class="row">
  						<div class="col-md-9 col-sm-9 borders">
  							<span>전화 : +82 010-5714-1535 / +81 080-4214-1535</span>
  						</div>
  						<div class="col-md-3 col-sm-3 borders">
	  						<span >사진</span>
	  					</div>
  					...
  					<div class="row">
  						<div class="col-md-9 col-sm-9 borders">
  							<span>주소 : HyoChonBill, SungNamDong, Daejeon, RePublic of Korea</span>
  						</div>
  						<div class="col-md-3 col-sm-3 borders">
	  						<span >사진</span>
	  					</div>
  					...
  					<div class="row">
  						<div class="col-md-2 col-sm-2 borders years">
	  						<span >년</span>
	  					</div>
	  					<div class="col-md-1 col-sm-1 borders years">
	  						<span>월</span>
	  					</div>
  						<div  class="col-md-9 col-sm-9 borders years">
  							<span>학력 및 이력</span>
  						</div>
  					</div>
  					<div class="row">
  					...
  					<div class="row">
  						...
  						<div class="col-md-9 col-sm-9 borders years">
  							<span>폴리텍&#8547;대학 대전캠퍼스 전기전자제어과 입학</span>
  						</div>
  					</div>
  					<div class="row">
  						<div class="col-md-2 col-sm-2 borders years">
  						...
  						<div class="col-md-9 col-sm-9 borders years">
  							<span>폴리텍&#8547;대학 대전캠퍼스 전기전자제어과 졸업</span>
  						</div>
  					</div>
  					<div class="row">
  						<div class="col-md-2 col-sm-2 borders years">
  					...
  					<div class="row">
  						...
  						<div class="col-md-9 col-sm-9 borders years">
  							<span>남양유업 천안 제1공장 입사 - 오퍼레이터(계약직)</span>
  						</div>
  					</div>
  					...
  					<div class="row">
  						...
  						<div class="col-md-9 col-sm-9 borders years">
  							<span>남양유업 천안 제1공장 퇴사 - 오퍼레이터(계약직)</span>
  						</div>
  					</div>
  					...
  					<!-- 이력서 끝 -->
					<div class="row">
						<div class="col-md-12 col-sm-12 change_line">
							<span>　</span>
						</div>
					...
					<!-- 자기소개서 시작 -->
  					...
  					<div class="row">
  						<div class="col-md-12 col-sm-12 borders years">
	  						<span>자 기 소 개</span>
	  					</div>
  					</div>
  					
  					<div class="row">
  						<div class="col-md-12 col-sm-12 borders">
	  						<span>
	  						...
	  						속도는 저의 강력한 장점이자 단점이라고 할 수 있습니다. 단점은 저는 속도의 비해서 오타로 인해 코드를 작성 할 때 에러를 자주 나옵니다.
	  						하지만 그로 인해서 에러의 종류 이유를 잘 파악할 수 있게 되었으며, 장점은 제가 일하는 속도가 빠름으로 인해서 일의 효율이 높습니다.
	  						위와 같이 저의 색깔이라고 말할 수 있습니다.
	  						</span>
	  					</div>
  					</div>
